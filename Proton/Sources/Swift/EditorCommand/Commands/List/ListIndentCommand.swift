...
public class ListIndentCommand: EditorCommand {
    ...
    public var name: CommandName {
        return CommandName("listIndentCommand")
    }

    /// Indents a list item if it supports indentation (e.g. unsupported item may mean item at first level)
